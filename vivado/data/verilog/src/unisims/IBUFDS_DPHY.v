  ...
  always @ (trig_attr) begin
   ...
   if ((attr_test == 1'b1) ||
        ((SIM_DEVICE != "ULTRASCALE_PLUS") &&
         ...
         (SIM_DEVICE != "EVEREST_ES1") &&
         (SIM_DEVICE != "EVEREST_ES2") &&
         (SIM_DEVICE != "EVEREST"))) begin
      $display("Error: [Unisim %s-102] SIM_DEVICE attribute is set to %s.  Legal values for this attribute are ULTRASCALE_PLUS, ULTRASCALE_PLUS_ES1, ULTRASCALE_PLUS_ES2, EVEREST, EVEREST_ES1, EVEREST_ES2. Instance: %m", MODULE_NAME, SIM_DEVICE);
      attr_err = 1'b1;
    end
...
//    end
  ...
  assign sim_mode = (SIM_DEVICE == "ULTRASCALE_PLUS" || SIM_DEVICE== "ULTRASCALE_PLUS_ES1" || SIM_DEVICE== "ULTRASCALE_PLUS_ES2") ? 1'b0 : 1'b1;
