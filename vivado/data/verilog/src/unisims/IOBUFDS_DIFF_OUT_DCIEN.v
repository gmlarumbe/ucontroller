...
`endif // `ifdef XIL_TIMING
	...
	case (DQS_BIAS)
     ...
     if ((SIM_DEVICE != "7SERIES") &&
      ...
      $display("Attribute Syntax Error : The attribute SIM_DEVICE on IOBUFDS_DIFF_OUT_DCIEN instance %m is set to %s.  Legal values for this attribute are 7SERIES or ULTRASCALE.",SIM_DEVICE);
         #1 $finish;
         end
