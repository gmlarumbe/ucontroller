...
//    buf B1 (O, IO);
    ...
    if ((SIM_DEVICE != "7SERIES") &&
      ...
      $display("Attribute Syntax Error : The attribute SIM_DEVICE on IOBUF_INTERMDISABLE instance %m is set to %s.  Legal values for this attribute are 7SERIES or ULTRASCALE.",SIM_DEVICE);
         #1 $finish;
         end
