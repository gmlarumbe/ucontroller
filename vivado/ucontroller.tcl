...
#
# ucontroller.tcl: Tcl script for re-creating project 'ucontroller'
#
# Generated by Vivado on Sun Feb 16 17:10:35 CET 2020
...
#
# 1. This project restoration tcl script (ucontroller.tcl) that was generated.
#
...
#
#    "../vivado/fifo_generator_0/fifo_generator_0.xci"
#    "../src/pkg/global_pkg.sv"
#    "../src/alu/rtl/alu.sv"
...
set _xil_proj_name_ "ucontroller"
...
set script_file "ucontroller.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/ucontroller"]"
...
set files [list \
 ...
 [file normalize "${origin_dir}/../src/pkg/global_pkg.sv"] \
 [file normalize "${origin_dir}/../src/alu/rtl/alu.sv"] \
 [file normalize "${origin_dir}/../src/misc/rtl/bin2bcd.sv"] \
 [file normalize "${origin_dir}/../src/cpu/rtl/cpu.sv"] \
 [file normalize "${origin_dir}/../src/dma/rtl/dma.sv"] \
 [file normalize "${origin_dir}/../src/dma/rtl/dma_arbiter.sv"] \
 [file normalize "${origin_dir}/../src/dma/rtl/dma_rx.sv"] \
 [file normalize "${origin_dir}/../src/dma/rtl/dma_tx.sv"] \
 [file normalize "${origin_dir}/../src/uart/rtl/fifo_wrapper.sv"] \
 [file normalize "${origin_dir}/../src/ram/rtl/gp_ram.sv"] \
 [file normalize "${origin_dir}/../src/ram/rtl/ram.sv"] \
 [file normalize "${origin_dir}/../src/top/rtl/ram_arbiter.sv"] \
 [file normalize "${origin_dir}/../src/ram/rtl/regs_ram.sv"] \
 [file normalize "${origin_dir}/../src/uart/rtl/sreg.sv"] \
 [file normalize "${origin_dir}/../src/uart/rtl/uart.sv"] \
 [file normalize "${origin_dir}/../src/uart/rtl/uart_rx.sv"] \
 [file normalize "${origin_dir}/../src/uart/rtl/uart_tx.sv"] \
 [file normalize "${origin_dir}/../src/top/rtl/ucontroller.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/fifo_generator_0/fifo_generator_0.xci"
...
set file "$origin_dir/../src/pkg/global_pkg.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/alu/rtl/alu.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/misc/rtl/bin2bcd.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/cpu/rtl/cpu.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/dma/rtl/dma.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/dma/rtl/dma_arbiter.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/dma/rtl/dma_rx.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/dma/rtl/dma_tx.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/uart/rtl/fifo_wrapper.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/ram/rtl/gp_ram.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/ram/rtl/ram.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/top/rtl/ram_arbiter.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/ram/rtl/regs_ram.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/uart/rtl/sreg.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/uart/rtl/uart.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/uart/rtl/uart_rx.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/uart/rtl/uart_tx.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/top/rtl/ucontroller.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ucontroller" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/../src/uart/tb/fifo_generator_0_sim_netlist.v"] \
 [file normalize "${origin_dir}/../src/top/tb/tb_clocks.sv"] \
 [file normalize "${origin_dir}/../src/top/tb/tb_program.sv"] \
 [file normalize "${origin_dir}/../src/top/tb/tb_top.sv"] \
 [file normalize "${origin_dir}/../src/dma/tb/tb_dma.sv"] \
 [file normalize "${origin_dir}/../src/alu/tb/tb_alu.sv"] \
 [file normalize "${origin_dir}/../src/misc/tb/tb_bin2bcd.sv"] \
 [file normalize "${origin_dir}/../src/cpu/tb/tb_cpu.sv"] \
 [file normalize "${origin_dir}/../src/ram/tb/tb_ram.sv"] \
 [file normalize "${origin_dir}/../src/uart/tb/tb_uart.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_1' fileset file properties for remote files
set file "$origin_dir/../src/top/tb/tb_clocks.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/top/tb/tb_program.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/top/tb/tb_top.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/dma/tb/tb_dma.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/alu/tb/tb_alu.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/misc/tb/tb_bin2bcd.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/cpu/tb/tb_cpu.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/ram/tb/tb_ram.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/../src/uart/tb/tb_uart.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
